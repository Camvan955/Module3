...
<center>
    ...
    <caption><h2>List of Users After Arrange</h2>
        <h2><a href="users?action=users">Back List All Users</a></h2>
    </caption>
</center>
...
<div align="center">
    <table class="border border-1" cellpadding="5">
        ...
        <c:forEach var="userArrange" items="${listUser}">
            <tr>
                <td><c:out value="${userArrange.id}"/></td>
                <td><c:out value="${userArrange.name}"/></td>
                <td><c:out value="${userArrange.email}"/></td>
                <td><c:out value="${userArrange.country}"/></td>
                <td>
                    <a href="/users?action=edit&id=${userArrange.id}">Edit</a>
                    <button onclick="inforDelete('${userArrange.getId()}','${userArrange.getName()}')" class="btn btn-primary"
